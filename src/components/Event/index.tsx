...
const TechnicalEvents = [
  {
    ...
    recommended: true,
    onsite: true,
    prize: ['Certificate from Kobelco'],
    type: 'Solo Registration',
    location: 'Rajam Hall, MIT',
    time: '10:30AM - 16th March',
  ...
  },
  {
    ...
    additionalImage: ['/Events/hackathon-2.jpg', '/Events/hackathon-3.jpg'],
    price: '500',
    open: true,
    recommended: true,
    onsite: false,
  ...
  },
  {
    ...
    hashtag: ['#Team', '#PaperPresentation'],
    description: [
